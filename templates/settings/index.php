<div id="app-settings">
	<div id="app-settings-header">
		<button type="button" class="settings-button" class="settings-button" data-apps-slide-toggle="#app-settings-content"><?php p($l->t('Settings')); ?></button>
	</div>
	<div id="app-settings-content">
		<div>
			<label for="tmdb_api_key"><?php p($l->t('API Key')); ?></label>
		...
		<div class="mar-top-20">
			<label for="hide_matching"><?php p($l->t('Hide matching entries')); ?></lable>
