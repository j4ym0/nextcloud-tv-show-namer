<div id="app-settings">
	...
	<div id="app-datasource-content">
		<div class="tvdb">
			<div class="powered"><span>TheTVDB</span><a href="https://thetvdb.com/subscribe" target="_blank" class="help"><img src="<?php echo \OC::$server->get(\OCP\IURLGenerator::class)->imagePath('tvshownamer', 'tvdb_dark.png') ?>" height="20px" title="<?php p($l->t('Metadata provided by TheTVDB. Please consider adding missing information or subscribing.')); ?>" /></a></div>
		...
		<div class="tmdb">
			<div class="powered"><span>The Movie DB</span><a href="https://www.themoviedb.org/" target="_blank" class="help"><img src="<?php echo \OC::$server->get(\OCP\IURLGenerator::class)->imagePath('tvshownamer', 'tmdb.svg') ?>" height="20px" title="TV Show Namer <?php p($l->t('uses TMDB and the TMDB APIs but is not endorsed, certified, or otherwise approved by TMDB.')); ?>" /></a></div>
			<div class="label-group">
			...
			<div class="label-group">
				...
				<a href="https://github.com/j4ym0/nextcloud-tv-show-namer/tree/main#getting-a-personal-api-key-for-tmdb" target="_blank" class="help"><?php p($l->t('Personal API key help')); ?></a>
